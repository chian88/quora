...
user1 = User.create(name: "David Stiennon", description: "I am just a regular person", location: "California", work: "Software Consultant")
user2 = User.create(name: "Chian Yee", description: "I am just a regular person", location: "Kuala Lumpur, Malaysia", work: "Financial Accountant")
topic1 = Topic.create(name: "Computer Science")
topic2 = Topic.create(name: "AI")
question1 = Question.create(body: "How does a beginner start to learn machine learning?", user: user1, topics: [topic1, topic2])
question2 = Question.create(body: "Can human level AI be reached?", user: user1, topics: [topic1, topic2])
